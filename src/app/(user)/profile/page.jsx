...
const Dashboard = () => {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-amber-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-amber-100">
            <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[600px]">
              {/* Sidebar Navigation */}
              <div className="lg:col-span-3 bg-gradient-to-b from-amber-50 to-amber-100/50 border-r border-amber-200 lg:block md:block hidden">
                    ...
                    {menuItems.map((item, index) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-left">
                            <div className={`font-semibold transition-colors ${
                              active === item.case ? 'text-amber-600' : 'text-gray-700'
                            }`}>
                              {item.name}
                            </div>
                        ...
                        <FaChevronRight className={`text-sm transition-transform ${
                          active === item.case ? 'text-amber-500 rotate-90' : 'text-gray-400'
                        }`} />
                      </button>
                    ))}
                  </nav>
